...
function updateItemCard(tick) { //DOM traversal
    tick.disabled = true;
    let previousSibling = tick.previousElementSibling;
    previousSibling.classList.add("p--linethrough");
    items[previousSibling.parentElement.id].checked = true;
}  
